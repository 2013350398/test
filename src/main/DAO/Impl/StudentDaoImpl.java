...
public class StudentDaoImpl implements StudentDao {
    ...
    public void addStudent(Student student) {
        String sql = "INSERT INTO student(st_id,st_name,st_pwd,st_sex,st_tel,st_email,st_type,su_id) VALUES(?,?,?,?,?,?,?,?) ";
        Connection con = null;
        try{
    ...
    public void updateStudent(Student student) {
        String sql = "update student set st_name=?,st_pwd=?,st_sex=?,st_email=?,st_tel=?,st_type=?,su_id=? where st_id=? ";
        Connection con = null;
        try{
            DruidUtil druidUtil=null;
            DataSource dataSource=druidUtil.getDataSource();
            ...
            psmt.setString(8, student.getSt_id());
            psmt.executeUpdate();
            psmt.close();
        }catch(Exception e){
            e.printStackTrace();
